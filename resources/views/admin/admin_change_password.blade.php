                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('update.password') }}">
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Konfirmasi Password
                                        Baru</label>
                                    <div class="col-sm-10">
                                ...
                                <input type="submit" class="btn btn-info waves-effect waves-light" value="Ganti Password">
                            </form>
