            ...
            <div class="dropdown d-inline-block user-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="{{ route('change.password') }}"><i
                            class="ri-wallet-2-line align-middle me-1"></i> Ganti Password</a>
                    <a class="dropdown-item" href="{{ route('admin.outlet.all') }}"><i
                            class="ri-wallet-2-line align-middle me-1"></i> Ganti Outlet</a>
