                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Halaman Tambah Outlet </h4><br><br>



                            <form method="post" action="{{ route('admin.outlet.store') }}" id="myForm"
                                ...
                                <input type="submit" class="btn btn-info waves-effect waves-light" value="Tambah Outlet">
                            </form>
