            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Detil Approval</h4>
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('admin.invoice.pending.list') }}"
                                class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i
                                    class="ri-arrow-left-fill"></i>&nbsp; Kembali ke
                                Pengajuan Pending</a> <br> <br>
                            ...
                            <form method="post" action="{{ route('admin.approval.store', $invoice->id) }}">
                                @csrf
                                ...
                                <button type="submit" class="btn btn-info">Approve Stok Keluar </button>
