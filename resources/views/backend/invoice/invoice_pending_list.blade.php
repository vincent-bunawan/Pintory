                                ...
                                <tbody>
                                    ...
                                    @foreach ($allData as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($item->status == '0')
                                                    <a href="{{ route('admin.invoice.approve', $item->id) }}"
                                                        class="btn btn-success sm" title="Approved Data"> <i
                                                            class="fas fa-check-circle"></i> </a>

                                                    <a href="{{ route('admin.invoice.reject', $item->id) }}"
                                                        class="btn btn-danger sm" title="Rejected Data">
