        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Laporan Mutasi Stok Keluar</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);"> </a></li>
                            <li class="breadcrumb-item active">Laporan Mutasi Stok Keluar</li>
                        </ol>
                    </div>
                                    ...
                                    <div class="">
                                            ...
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><strong>No Invoice </strong>
                                                        </td>
                                                        <td class="text-center"><strong>Tanggal</strong>
                                                        </td>
                                                        <td class="text-center"><strong>Deskripsi</strong>
                                                        </td>
                                        ...
                                        <div class="d-print-none">
                                            <div class="float-end">
                                                ...
                                                <a href="{{ route('admin.print.daily.invoice.pdf',['start_date'=>$start_date,'end_date'=>$end_date]) }}"
                                                    class="btn btn-primary waves-effect waves-light ms-2">Export PDF</a>
                                                <a href="{{ route('admin.export.daily.invoice',['start_date'=>$start_date,'end_date'=>$end_date]) }}"
