                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Mutasi Stok Masuk</li>
                            </ol>
                        </div>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="d-print-none">
                                                <div class="float-end">
                                                    ...
                                                    <a href="{{ route('admin.print.daily.purchase.pdf', ['start_date' => $start_date, 'end_date' => $end_date]) }}"
                                                        class="btn btn-primary waves-effect waves-light ms-2">Export PDF</a>
                                                    <a href="{{ route('admin.export.daily.purchase', ['start_date' => $start_date, 'end_date' => $end_date]) }}"
