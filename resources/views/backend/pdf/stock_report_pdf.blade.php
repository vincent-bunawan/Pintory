                                        ...
                                        <div class="">
                                                ...
                                                <table class="table">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><strong>Nama Supplier</strong></td>
                                                            <td class="text-center"><strong>Unit </strong>
                                                            </td>
                                                            <td class="text-center"><strong>Kategori</strong>
                                                            </td>
                                                            <td class="text-center"><strong>Nama Produk</strong>
                                                            </td>
                                            ...
                                            <div class="d-print-none">
                                                <div class="float-end">
                                                    ...
                                                    <a href="{{ route('admin.print.stock.report.pdf') }}"
                                                        class="btn btn-primary waves-effect waves-light ms-2">Export PDF</a>
                                                    <a href="{{ route('admin.export.stock.report') }}"
                                                        class="btn btn-success waves-effect waves-light ms-2">Export XLSX</a>
