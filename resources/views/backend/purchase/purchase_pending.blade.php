                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{-- <a href="{{ route('admin.purchase.add') }}"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($allData as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($item->status == '0')
                                                    <a href="{{ route('admin.purchase.approve', $item->id) }} "
                                                        class="btn btn-success sm" title="Approved" id="ApproveBtn"> <i
                                                            class="fas fa-check-circle"></i> </a>
                                                    <a href="{{ route('admin.purchase.reject', $item->id) }} "
                                                        class="btn btn-danger sm" title="Rejected" id="RejectBtn">Tolak</a>
                                                @endif
                                            </td>
