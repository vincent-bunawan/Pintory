                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Form Edit Customer </h4><br><br>



                            <form method="post" action="{{ route('employee.customer.update') }}" id="myForm"
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">No Telp Customer
                                    </label>
                                    <div class="form-group col-sm-10">
