                                    ...
                                    <div class="">
                                        ...
                                        <div class="d-print-none">
                                            <div class="float-end">
                                                ...
                                                <a href="{{ route('employee.print.daily.invoice.pdf',['start_date'=>$start_date,'end_date'=>$end_date]) }}"
                                                    class="btn btn-primary waves-effect waves-light ms-2">Export PDF</a>
                                                <a href="{{ route('employee.export.daily.invoice',['start_date'=>$start_date,'end_date'=>$end_date]) }}"
