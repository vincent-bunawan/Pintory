                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Tambah Produk Baru </h4><br><br>



                            <form method="post" action="{{ route('admin.product.store') }}" id="myForm">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Stok Awal </label>
                                    <div class="form-group col-sm-10">
                                ...
                                <input type="submit" class="btn btn-info waves-effect waves-light" value="Tambah Produk">
                            </form>
