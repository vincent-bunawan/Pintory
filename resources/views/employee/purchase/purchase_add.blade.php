                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Tambah Stok Masuk </h4><br><br>
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('employee.purchase.store') }}">
                                @csrf
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $(document).on("click", ".addeventmore", function() {
                ...
                if (purchase_no == '') {
                    $.notify("Nomor Pembelian harus diisi", {
                        globalPosition: 'top right',
                        className: 'error'
                    });
                    return false;
