                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Form Edit Supplier </h4><br><br>



                            <form method="post" action="{{ route('employee.supplier.update') }}" id="myForm">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">No Telp Supplier
                                    </label>
                                    <div class="form-group col-sm-10">
